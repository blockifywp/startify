...
<div class="wp-block-group alignfull alignfull"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"1em","bottom":"1em"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group alignwide alignwide" style="padding-top:1em;padding-bottom:1em"><!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Search this website","buttonText":"Search","buttonUseIcon":true,"style":{"spacing":{"margin":{"left":"0px"}}},"className":"is-style-toggle"} /-->

<!-- wp:group {"style":{"spacing":{"blockGap":"0.3em"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
