...
<p class="aligncenter has-text-align-center aligncenter">Simple pricing plans for any size team.</p>
<!-- /wp:paragraph -->

<!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"2em","bottom":"3em"},"blockGap":"2em"}}} -->
<div class="wp-block-columns are-vertically-aligned-center" style="padding-top:2em;padding-bottom:3em"><!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"2em","right":"2em","bottom":"2em","left":"2em"}},"border":{"width":"1px"}},"layout":{"contentSize":"240px"}} -->
...
<h5 class="has-text-align-center">Basic</h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"neutral-400","fontSize":"16"} -->
<p class="aligncenter has-text-align-center has-neutral-400-color has-text-color has-16-font-size aligncenter">Save 100% - <s>$97.00</s></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":6,"fontSize":"60"} -->
<h6 class="has-text-align-center has-60-font-size"><sup>$</sup>0</h6>
<!-- /wp:heading -->
...
<ul class="is-style-checklist has-18-font-size" style="margin-top:1em"><li>Pro blocks &amp; patterns</li><li>WooCommerce</li><li>Developer tools</li><li>White label</li></ul>
<!-- /wp:list -->
...
<!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"2em","right":"2em","bottom":"2em","left":"2em"}},"border":{"width":"1px"}},"layout":{"contentSize":"240px"},"borderColor":"primary-600"} -->
...
<h5 class="has-text-align-center">Pro</h5>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"align":"center","fontSize":"16"} -->
<p class="aligncenter has-text-align-center has-16-font-size aligncenter">Everything in Basic plan with unlimited use plus:</p>
<!-- /wp:paragraph -->
