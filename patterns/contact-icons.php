...
<!-- wp:heading {"textAlign":"center","level":5} -->
<h5 class="has-text-align-center">Phone</h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="aligncenter has-text-align-center aligncenter">Call our support team</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"primary-600"} -->
<p class="aligncenter has-text-align-center has-primary-600-color has-text-color aligncenter"><a href="#">+555-1234-56789</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"width":24,"height":24,"style":{"spacing":{"padding":{"top":"0.9em","right":"0.9em","bottom":"0.9em","left":"0.9em"}},"border":{"radius":"999px","width":"2px"}},"className":"has-custom-border is-style-icon","textColor":"primary-600","icon":"map-marker","svgString":"\u003csvg xmlns=\u0022http://www.w3.org/2000/svg\u0022 viewBox=\u00220 0 24 24\u0022\u003e\u003cpath fill-rule=\u0022evenodd\u0022 d=\u0022M12 9c-.8 0-1.5.7-1.5 1.5S11.2 12 12 12s1.5-.7 1.5-1.5S12.8 9 12 9zm0-5c-3.6 0-6.5 2.8-6.5 6.2 0 .8.3 1.8.9 3.1.5 1.1 1.2 2.3 2 3.6.7 1 3 3.8 3.2 3.9l.4.5.4-.5c.2-.2 2.6-2.9 3.2-3.9.8-1.2 1.5-2.5 2-3.6.6-1.3.9-2.3.9-3.1C18.5 6.8 15.6 4 12 4zm4.3 8.7c-.5 1-1.1 2.2-1.9 3.4-.5.7-1.7 2.2-2.4 3-.7-.8-1.9-2.3-2.4-3-.8-1.2-1.4-2.3-1.9-3.3-.6-1.4-.7-2.2-.7-2.5 0-2.6 2.2-4.7 5-4.7s5 2.1 5 4.7c0 .2-.1 1-.7 2.4z\u0022/\u003e\u003c/svg\u003e"} -->
<figure class="wp-block-image is-resized has-custom-border is-style-icon has-primary-600-color has-text-color" style="border-radius:999px;border-width:2px;padding-top:0.9em;padding-right:0.9em;padding-bottom:0.9em;padding-left:0.9em"><img src="#" alt="" width="24" height="24"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"textAlign":"center","level":5} -->
<h5 class="has-text-align-center">Address</h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="aligncenter has-text-align-center aligncenter">Find our office here</p>
<!-- /wp:paragraph -->
