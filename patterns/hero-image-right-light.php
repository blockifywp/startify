...
<!-- wp:paragraph -->
<p>Work with the world's leading web development experts for success with your next project</p>
<!-- /wp:paragraph -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"style":{"aspectRatio":"5/4"},"className":"is-style-placeholder","backgroundColor":"neutral-25"} -->
<figure class="wp-block-image is-style-placeholder has-neutral-25-background-color has-background" style="aspect-ratio:5/4;--wp--custom--placeholder-line--color:var(--wp--custom--border--color)"><img src="#" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
