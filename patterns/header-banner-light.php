<?php
/**
 * Title: Header Banner Light
 * Slug: header-banner-light
 * Categories: header
...
<!-- wp:separator {"align":"full","style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"textColor":"neutral-100"} -->
<hr class="wp-block-separator alignfull has-alpha-channel-opacity has-neutral-100-color has-text-color has-neutral-100-color has-text-color alignfull" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"/>
<!-- /wp:separator --></div>
<!-- /wp:group -->
