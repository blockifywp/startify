...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":3,"textColor":"white"} -->
<h3 class="has-white-color has-text-color">Start your next project.</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit<strong>.</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button"><a class="wp-block-button__link">Start now</a></div>
<!-- /wp:button -->
